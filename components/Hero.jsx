  ...
  return (
    ...
    <section className="bg-[url('/asset/mansion_with_pool.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center h-screen text-white text-center">
            ...
            <Link href="/listings" target="_blank" className="border-3 border-white px-[2rem] py-[0.8rem] uppercase text-[0.9rem] font-semibold hover:bg-white hover:text-black transition ease-in-out my-5">see listings</Link>
        </div>
    </section>
    </>
  )
